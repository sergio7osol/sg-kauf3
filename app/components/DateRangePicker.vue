...
const selected = defineModel<Range | null>({ default: null });
...
const clearSelection = () => {
  selected.value = null as unknown as Range;
};

const hasSelection = computed(() => selected.value?.start && selected.value?.end);
</script>
...
<template>
  ...
  >
    <UButton
      ...
      class="data-[state=open]:bg-elevated group min-w-[220px]"
    >
      <span class="truncate">
      ...
      <div class="flex items-stretch sm:divide-x divide-default">
        <div class="hidden sm:flex flex-col justify-center">
          ...
          <UButton
            ...
            color="error"
            variant="ghost"
            class="rounded-none px-4 mt-2 border-t border-default"
            icon="i-lucide-x"
