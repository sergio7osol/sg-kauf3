...
const columns: TableColumn<Shop>[] = [
  ...
  },
  {
    ...
    header: '',
    enableHiding: false,
    cell: ({ row }: { row: { original: Shop, getIsExpanded: () => boolean, toggleExpanded: () => void } }) => {
        ...
        <section class="flex flex-col gap-4">
          <div class="flex flex-wrap gap-3 items-center justify-between">
            ...
            <div class="text-sm text-muted">
              {{ filteredShops.length }} / {{ totalCount }} visible
            </div>
          </div>
              ...
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <p class="text-sm text-gray-500">
                    Live data from <small>/api/shops?includeAddresses=1</small> (user: <span class="font-mono">{{ user?.name }}</span>)
                  </p>
                </div>
                <UBadge
                  color="gray"
                  ...
                  <template #expanded="{ row }">
                    <div class="p-4 bg-gray-50/50">
                      <div class="text-sm font-medium text-gray-700 mb-3">
                        Addresses for {{ row.original.name }}
                      </div>
                      <div class="space-y-2">
                        <div
